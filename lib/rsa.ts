...
export async function pemToRSAKeyDict(pem: string, type: "public" | "private"): Promise<any> {
...
export async function decryptWalletData(encryptedJson: string, password: string): Promise<any> {
